...
public class Grade {
    public static void main(String[] args) {
        ...
        System.out.println("grade B: "+ gradeOfB.size());
        System.out.println("grade C: "+ gradeOfC.size());
        System.out.println("grade D: "+ gradeOfD.size());
        System.out.println("grade F: "+ gradeOfF.size());
