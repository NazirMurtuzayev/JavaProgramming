...
public class StringInfo {
    public static void main(String[] args) {
        ...
        System.out.println(str1==str2); // because they are not same object
        System.out.println(str2==str3); // because they are not same object
        System.out.println(str3==str4);// because they are not same object
