...
public class Account {
    public static void main(String[] args) {
        ...
        if(accountNumber.charAt(0)=='2'){
            System.out.println(accountNumber.length()==7);
            result="Valid";
        }else if (accountNumber.charAt(0)=='5'){
                System.out.println(accountNumber.length()==10);
            result="Valid";
...
/*
 6. Create a class called AccountNumber.
       Ask the user enter an account number (String). Check if these account number
       is valid.
