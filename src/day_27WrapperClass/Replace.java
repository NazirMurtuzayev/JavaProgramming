...
public class Replace {
    ...
    public static class InsertParameters {
...
1. Replace Task:
  1.1 Create a method named replace that passes three parameters:
    integer array, integer index, integer newElement. The method
     replaces the element of the array at given index with the new
      ...
      1.2 Create the same functions for double arrays, char arrays,
      and String arrays
